...
export abstract class IQuery {
  ...
  abstract userGoals():
    | Nullable<Nullable<Goal>[]>
    | Promise<Nullable<Nullable<Goal>[]>>;
}
...
export abstract class IMutation {
  ...
  abstract incrementScore(
    inputStuff?: Nullable<GoalScoreInput>,
  ): Nullable<Goal> | Promise<Nullable<Goal>>;

  abstract decrementScore(
    inputStuff?: Nullable<GoalScoreInput>,
  ): Nullable<Goal> | Promise<Nullable<Goal>>;
  ...
  abstract editGoalTitle(
    goalId?: Nullable<number>,
